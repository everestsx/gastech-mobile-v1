/**
 * Odoo/Drive config for Expo Go, local Gradle, and EAS APKs.
 * @env is inlined from a .env file at Metro time (local/dev).
 * EAS bakes the same keys into Expo extra via app.config.js (standalone APK).
 */
